        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup().addGap(85, 85, 85)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel1).addComponent(jLabel4).addComponent(jLabel2))
                                .addGap(35, 35, 35)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(mnt).addComponent(num).addComponent(motif,
            ...
            if (!mnt.getText().isEmpty() && Float.parseFloat(mnt.getText()) >= 0) {
                if (!motif.getText().isEmpty()) {
                    ...
                    if (1 == 1) {// if le client a le solde on finalise l'operation
                        // same here 0 to avoid an error made by bilal & i donnow how to fix it
