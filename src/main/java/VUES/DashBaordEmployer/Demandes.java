...
public class Demandes extends javax.swing.JPanel implements ListSelectionListener {
    ...
    private void initComponents() {
        ...
        demandes.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        layout.setHorizontalGroup(layout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jScrollPane1,
                        javax.swing.GroupLayout.PREFERRED_SIZE, 758, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void valueChanged(ListSelectionEvent event) {
        if (event.getSource() == demandes.getSelectionModel() && event.getValueIsAdjusting()) {
            try {
                ...
                new DemandeInfos(numcompte, cin, nom, prenom, email, tel, ville, address, date_nais, date_creation)
                        .setVisible(true);
